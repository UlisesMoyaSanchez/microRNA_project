...
\begin{frame}{Hip\'otesis y preguntas del proyecto}
  ...
  \begin{enumerate}
    \item \textbf{Clasificaci\'on}: \`Puede el modelo reconocer correctamente 11 tipos celulares?
    \item \textbf{Link prediction}: \`Puede distinguir qu\'e pares miRNA-gen son plausibles en este contexto?
    \item \textbf{Interpretabilidad}: \`Qu\'e miRNAs y circuitos emergen como candidatos biol\'ogicos prioritarios?
    \item \textbf{Traducci\'on}: \`Qu\'e resultados son suficientemente estables para guiar validaci\'on externa?
  \end{enumerate}
\end{frame}
